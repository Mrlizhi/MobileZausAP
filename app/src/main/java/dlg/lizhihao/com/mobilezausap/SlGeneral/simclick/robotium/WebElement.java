...
public class WebElement {
	...
	public String toString() {
		...
		return "id = " + id + ", text = " + text + ", name = " + name + ", class name = " + className
	...
	public String getXpath() {
		...
		Set<Map.Entry<String, String>> entrySet = getAttributes().entrySet();
		Iterator itor = entrySet.iterator();
		boolean isFirst = true;
		if ((null != getAttribute("href") && !"".equals(getAttribute("href")))) {
			try {
				xpath = String.format(xpath, getTagName(), "href",
						(null != getAttribute("href") && !"".equals(getAttribute("href"))) ?
								URLEncoder.encode(getAttribute("href"), "UTF-8") : getAttribute("href"));
			...
			while (itor.hasNext()) {
				...
				if (isFirst) {
					xpath = String.format(xpath, getTagName(), attrName, attrValue);
					isFirst = false;
				} else {
