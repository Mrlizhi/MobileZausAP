...
class SgRobotiumWebClient extends WebChromeClient{
	...
	public SgRobotiumWebClient(Handler handler, WebElementCreator webElementCreator){
	...
	public boolean onJsPrompt(WebView view, String url, String message,	String defaultValue, JsPromptResult r) {
		...
		if(message != null && (message.contains(";,") || message.contains("robotium-finished"))){
			...
			Log.i(SgRobotiumWebClient.class.getSimpleName(), "alert !!!!!!!!!!!!!!!!!!!!!!");
			return true;
		}
