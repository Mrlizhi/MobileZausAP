...
public class Solo {
	...
	public boolean waitForWebElement(By by) throws WebElementNotFound {
		if(config.commandLogging){
	...
	public boolean waitForWebElement(By by, int timeout, boolean scroll) throws WebElementNotFound {
		if(config.commandLogging){
	...
	public boolean waitForWebElement(By by, int minimumNumberOfMatches, int timeout, boolean scroll) throws WebElementNotFound {
		if(config.commandLogging){
	...
	*/
	...
	public void enterTextInWebElement(By by, String text) throws WebElementNotFound {
		if(config.commandLogging){
	...
	public void typeTextInWebElement(By by, String text) throws WebElementNotFound {
		if(config.commandLogging){
	...
	public void typeTextInWebElement(By by, String text, int match) throws WebElementNotFound {
		if(config.commandLogging){
	...
	public WebElement getWebElement(By by, int index) throws WebElementNotFound {
		if(config.commandLogging){
