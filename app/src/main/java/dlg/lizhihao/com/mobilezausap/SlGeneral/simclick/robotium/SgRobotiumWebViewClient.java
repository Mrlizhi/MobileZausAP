...
public class SgRobotiumWebViewClient extends WebViewClient {

    private static final String TAG = SgRobotiumWebViewClient.class.getSimpleName();

    private Handler mHandler;
    private WebViewClient robotiumWebClient;
    private WebViewClient originalWebViewClient = null;

    public SgRobotiumWebViewClient(Handler handler){
